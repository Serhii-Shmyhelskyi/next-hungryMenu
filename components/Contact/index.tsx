...
const Contact: FC = () => {
  ...
  let handleSubmit = async (e: any) => {
    ...
    // valid input
    if (!regName.test(allDate.name)) {
      setInputValid("Name");
    } else if (!regEmail.test(allDate.email)) {
      setInputValid("Email");
    } else if (!regPhone.test(allDate.phone)) {
      setInputValid("Phone");
    } else if (!regName.test(allDate.messege)) {
    ...
    <>
      {visible ? (
            ...
            <div className={styles.contact__inner}>
              ...
              <form
                ...
                <input
                  ...
                  value={allDate.name}
                  onChange={(e) =>
                    setAllDate({ ...allDate, name: e.target.value })
                  }
                  placeholder="Name"
                  required
                />
                <input
                  ...
                  value={allDate.email}
                  onChange={(e) =>
                    setAllDate({ ...allDate, email: e.target.value })
                  }
                  placeholder="Email"
                  required
                />
                <input
                  ...
                  value={allDate.phone}
                  onChange={(e) =>
                    setAllDate({ ...allDate, phone: e.target.value })
                  }
                ...
                <input
                  ...
                  type="text"
                  value={allDate.messege}
                  placeholder="Messege"
                  onChange={(e) =>
                    setAllDate({ ...allDate, messege: e.target.value })
                  }
                  required
                />
        ...
        <div
          ...
          <div className="container">
            <h2>Thank's {allDate.name} for your messege</h2>
            <div>
              <img src="/images/gallery-8-big.jpg" alt="messege" />
            </div>
            <Link href="/">
